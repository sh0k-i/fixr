...
interface PromoFloatingProps {
  handleClick: () => void;  // Define the prop type for the function
}

const PromoFloating: React.FC<PromoFloatingProps> = ({ handleClick }) => {
  return (
    <aside
    ...
    >
      <a
        ...
        onClick={(e) => {
          ...
          handleClick();       // Trigger the passed function
        }}
