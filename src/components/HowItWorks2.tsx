  ...
  return (
    <div className="bg-white">
      ...
      <div className="space-y-8 sm:space-y-10 pointer-events-none">
        <BlurFade inView delay={2 * 0.15} yOffset={0} className="space-y-2 md:space-y-4 text-center">
        ...
        <div className="flex justify-center items-center">
          <div className="grid sm:grid-cols-1 md:grid-cols-3 items-center gap-12">
            {/* <!-- Icon Block --> */}
            <BlurFade inView delay={3 * 0.15} yOffset={0}  className="text-center">
              <div className="flex justify-center items-center ">
            ...
            {/* <!-- Icon Block --> */}
            <BlurFade inView delay={4 * 0.15} yOffset={0}  className="text-center">
              <div className="flex justify-center items-center ">
            ...
            {/* <!-- Icon Block --> */}
            <BlurFade inView delay={5 * 0.15} yOffset={0}  className="text-center">
              <div className="flex justify-center items-center ">
