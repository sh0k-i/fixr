...
import Step3Specifications from '../forms/Step3Specifications';
import ProgressBar from '../ui/ProgressBar';
import Step1Info from '../forms/Step1Info';
import Step2PromoOptIn from '../forms/Step2PromoOptIn';
import Summary from '../forms/Summary';
import ServiceWithNavButtons from './ServiceWithNavButtons';
import ScheduleNoNav from './ScheduleNoNav';
...
const EZBathForm = () => {
  ...
  useEffect(() => {
    if (services.length === 1) {
      ...
      // If we are on step 2 (selection) and there is only one service, move to step 3 (specifications)
      if (currentStep === 2) {
        setCurrentStep(3)
      }
    }
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div>
        {currentStep === 1 && <ScheduleNoNav onNext={handleNextStep} />}
        {currentStep === 2 && <ServiceWithNavButtons onNext={handleNextStep} onBack={handleBackStep} onReset={handleReset} />}
        {currentStep === 3 && <Step3Specifications onNext={handleNextStep} onBack={handleBackStep} onReset={handleReset} />}
        {currentStep === 4 && <Step1Info onNext={handleNextStep} onReset={handleReset} onBack={handleBackStep} />}
        {currentStep === 5 && <Step2PromoOptIn onNext={handleNextStep} onBack={handleBackStep} onReset={handleReset} />}
