...
const NavBar2 = () => {
  ...
  // Extract company_phone from URL parameters
  const searchParams = new URLSearchParams(location.search);
  const companyPhone = searchParams.get('company_phone') || '+18594075999'; // Fallback to default if not provided
              ...
              <div className="flex items-center gap-4">
                <div className="flex sm:gap-4">
                  <a
                    ...
                    href={`tel:${companyPhone}`} // Use dynamic company_phone
                  >
